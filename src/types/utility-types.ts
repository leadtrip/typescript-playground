/**
 When a particular type feels like it's useful in most  codebases, they are added into TypeScript and become
 available for anyone which means you can consistently rely on their availability
*/
...
const myPartialSticker: StickerUpdateParam = {id: 1}

// ===================== Readonly<Type> =====================
// Takes an object and makes its properties read-only.

type StickerFromAPI = Readonly<Sticker>;
const myStickerFromAPI: StickerFromAPI = {id: 1, name: 'bob', createdAt: '15-08-2023', updatedAt: '16-08-2023', submitter: 'dave'}
...
let myStickerSortPreview: StickerSortPreview = {name: 'jim', updatedAt: '15-08-2023'}
...
const myStickerTimeMetadata: StickerTimeMetadata = {id: 1, createdAt: '15-08-2023', updatedAt: '16-08-2023', submitter: 'dave'}
...
// Unlike other types, ThisType does not return a new type but instead manipulates the definition of this inside a function.
// You can only use ThisType when you have noImplicitThis turned on in your TSConfig.
